...
import com.cli.bnk.exceptionhandler.MisMatchAccountTypeException;
...
public enum AccountType {
	...
	public static String selectAccountType(String accountType) {
		...
		throw new MisMatchAccountTypeException("Please enter correct account type",HttpStatus.BAD_REQUEST);
	}
