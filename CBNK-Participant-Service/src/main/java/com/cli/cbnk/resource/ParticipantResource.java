...
public class ParticipantResource {
	...
	@DeleteMapping("/delete/{accountId}/{userName}/{password}")
	public void deleteCustomerAccount(@PathVariable long accountId, @PathVariable String userName,
			@PathVariable String password) {
		customerService.deleteCustomerAccount(accountId, userName, password);
	}
}
